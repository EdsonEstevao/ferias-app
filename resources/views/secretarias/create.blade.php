...
<x-app-layout>
    ...
    <h2 class="mb-6 text-2xl font-semibold">Adicionar Secretaria</h2>

    <div class="max-w-2xl p-6 mx-auto mt-6 bg-white rounded shadow">
        <h2 class="mb-4 text-xl font-bold text-gray-800">📌 Cadastrar Secretaria</h2>
        ...
        <form action="{{ route('secretarias.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="secretaria_origem_id" class="block text-sm font-medium text-gray-700">Secretaria de Origem
                    (opcional)</label>
