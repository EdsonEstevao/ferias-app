            ...
            <div class="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <select id="statusFilter"
                        ...
                        <option value="ativo" {{ request()->get('status') == 'ativo' ? 'selected' : '' }}>Ativos
                        </option>
                        < value="inativo" {{ request()->get('status') == 'inativo' ? 'selected' : '' }}>Inativos</>
                    </select>
                </div>
                    ...
                    <select id="departamentoFilter"
                        ...
                        @foreach ($departamentos as $departamento)
                            <option value="{{ $departamento }}"
                                {{ request()->get('departamento') == $departamento ? 'selected' : '' }}>
                                {{ $departamento }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="flex items-center justify-between p-4 border-b border-gray-200 sm:p-6">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select id="sortSelect"
                        ...
                        <option value="nome_desc" {{ request()->get('sort') == 'nome_desc' ? 'selected' : '' }}>Nome
                            Z-A
                        </option>
